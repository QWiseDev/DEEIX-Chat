...
export namespace Mcp {
   ...
   * @tags mcp
   * @name RagflowDocumentsPreviewList
   * @summary 预览 RAGFlow 知识库原文件
   * @request GET:/mcp/ragflow/documents/{document_id}/preview
   * @secure
   */
  export namespace RagflowDocumentsPreviewList {
    export type RequestParams = {
      /** RAGFlow 文档 ID */
      documentId: string;
    };
