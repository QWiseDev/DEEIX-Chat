...
var exactErrorSpecs = map[string]errorSpec{
	...
	"provider type must be oidc, oauth2 or dingtalk":              {Code: "auth.provider_type_invalid", Message: "provider type must be oidc, oauth2 or dingtalk"},
	"provider must be dingtalk":                                   {Code: "auth.provider_type_invalid", Message: "provider must be dingtalk"},
	"dingtalk corp id is required":                                {Code: "auth.dingtalk_corp_id_required", Message: "DingTalk corp id is required"},
	"dingtalk user is not an enterprise member":                   {Code: "auth.dingtalk_enterprise_member_required", Message: "DingTalk user is not an enterprise member"},
...
var fallbackMessages = map[string]string{
	...
	"auth.provider_type_invalid":                        "provider type must be oidc, oauth2 or dingtalk",
	"auth.dingtalk_corp_id_required":                    "DingTalk corp id is required",
	"auth.dingtalk_enterprise_member_required":          "DingTalk user is not an enterprise member",
